...
var stopurl=document.referrer;
	function singo(){
		...
		document.repFrm.action="leLCReportProc.jsp?stopid=<%=stopid%>&renum=<%=renum%>&conum=<%=conum%>&stuc_depth=<%=stuc_depth%>";
...
<div class="frame">
    <div class="content">
		...
		<table width="300">
		<tr>
		<td><input type="hidden" name="kind" value="과외리뷰게시판댓글"></td>	
