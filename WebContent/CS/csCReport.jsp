...
var stopurl=document.referrer;
	function singo(){
		...
		document.repFrm.action="csCReportProc.jsp?stopid=<%=stopid%>&renum=<%=renum%>&conum=<%=conum%>&ccr_depth=<%=ccr_depth%>";
	}
...
<div class="frame">
    ...
    <hr style="border:1px solid red;">
		...
		<tr>
		<td><input type="hidden" name="kind" value="고객센터댓글"></td>	
		...
		<td  align="center">
				<table align="center" >
						...
						<td><input type="hidden" name="ccr_depth" value="<%=ccr_depth%>"></td>
