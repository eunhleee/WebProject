...
public class SCommentBean {
	...
	private int stuc_conum;
	private int stuc_depth;
	...
	public int getStuc_conum() {
		return stuc_conum;
	}
	public void setStuc_conum(int stuc_conum) {
		this.stuc_conum = stuc_conum;
	}
	public int getStuc_depth() {
		return stuc_depth;
	}
	public void setStuc_depth(int stuc_depth) {
		this.stuc_depth = stuc_depth;
	}
